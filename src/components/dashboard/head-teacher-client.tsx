...
export function HeadTeacherClient() {
  ...
  if (isLoading) {
    return (
      <section>
        <PageHeader title="Loading School Data..." />
  ...
  if (fetchError) {
    return (
      <section className="text-center">
        <PageHeader title="Error Loading Data" description={fetchError} />
        ...
        <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as TabName)} className="w-full">
            ...
            <TabsContent value="overview" className="mt-6">
                 <section className="space-y-8">
                    <PageHeader title="School Overview" description="Get a quick glance at the status of teacher workbook submissions and overall school activity." />
            ...
            <TabsContent value="pending" className="mt-6">
                <section>
                    <PageHeader title="Pending Tasks" description="Review and update the status of tasks that teachers have submitted." />
                    <Card className="shadow-lg rounded-lg">
                        <CardHeader>
            ...
            <TabsContent value="reports" className="mt-6">
                 <section>
                    <PageHeader title="Reports" description="Analyze teacher submission timeliness and export reports to PDF or Excel (CSV)." />
            ...
            <TabsContent value="assessment" className="mt-6">
                 <section>
                    <PageHeader title="Teacher Assessment" description="This checklist shows the completion status of key administrative tasks for each teacher, derived from records across the platform. Add your own notes and save for your records." />
